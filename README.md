...
> - **Tech Stack:** Vue.js · Node.js(Express) · Socket.IO · Whisper(STT) · Polyglot-ko + LoRA · Pinecone(Vector DB)  
> - **Features:** 실시간 음성 인식, 키워드 추천, 자동 노드 생성, 2D/3D Mind Map Visualization  
> - **Research Output:** 한국인터넷정보학회 발표 논문

#### 💌 [For You](https://github.com/BestDAOU)
> AI 기반 맞춤형 문자메시지 자동 생성 플랫폼  
> - **Tech Stack:** React · Express · OpenAI API  
> - **Features:** 목적별 자동 메시지 생성(축하, 초대, 부고 등) 및 이미지 자동 생성 기능  
> - **Goal:** 일상 커뮤니케이션의 효율화 및 감성 전달 보조  
...
<img src="https://img.shields.io/badge/Whisper-AI-blue?style=flat"/> 

**Database / Infra:**  
<img src="https://img.shields.io/badge/MySQL-4479A1?style=flat&logo=mysql&logoColor=white"/> 
<img src="https://img.shields.io/badge/Pinecone-0E5EFF?style=flat&logo=pinecone&logoColor=white"/>  
